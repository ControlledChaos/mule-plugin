...
class Dashboard {
    ...
    public function metaboxes() {
        ...
        if ( mule_acf_options() ) {
            ...
            $hide = get_field( 'mule_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            $activity   = get_option( 'mule_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Welcome Panel', 'mule-plugin' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'mule-plugin' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once MULE_PATH . 'admin/dashboard/partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once MULE_PATH . 'admin/dashboard/partials/help/help-dashboard-widgets.php';
    ...
    public function help_dashboard_sidebar() {
        ...
        $html  = sprintf(
            '<h4>%1s %2s</h4>',
            __( 'Custom Dashboard for', 'mule-plugin' ),
             get_bloginfo( 'name' )
        );
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( MULE_ADMIN_SLUG . '-dashboard', MULE_URL .  'admin/dashboard/assets/css/dashboard.min.css', [], null, 'screen' );
        }
