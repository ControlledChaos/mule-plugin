...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( mule_acf_options() ) {
            ...
            $options = get_field( 'mule_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( mule_acf_options() ) {
            $links = get_field( 'mule_links_manager', 'option' );
        } else {
            $links = get_option( 'mule_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( mule_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'mule_hide_appearance' );
            $plugins    = get_option( 'mule_hide_plugins' );
            $users      = get_option( 'mule_hide_users' );
            $tools      = get_option( 'mule_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( mule_acf_options() ) {
            ...
            $menus_link   = get_field( 'mule_menus_position', 'option' );
            $widgets_link = get_field( 'mule_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'mule_menus_position' );
            $widgets_link = get_option( 'mule_widgets_position' );
