...
class Extend_ACF {
	...
	public function admin_styles() {
		...
		wp_enqueue_style( MULE_ADMIN_SLUG . '-acf-admin', MULE_URL . 'includes/acf/assets/css/admin.min.css', [], MULE_VERSION, 'screen' );
	...
	public function admin_scripts() {
		...
		wp_enqueue_script( MULE_ADMIN_SLUG . '-acf-admin', MULE_URL . 'includes/acf/assets/js/admin.min.js', [ 'jquery' ], MULE_VERSION, true );
