...
class Post_Types_Taxes {
	...
	public function dependencies() {
		...
		require_once MULE_PATH . 'includes/post-types-taxes/class-post-type-front-page.php';

		// Number of posts per archive page.
		require_once MULE_PATH . 'includes/post-types-taxes/class-posts-per-page.php';

		// Drag & drop custom post and taxonomy orders.
		require_once MULE_PATH . 'includes/post-types-taxes/class-post-type-order.php';
