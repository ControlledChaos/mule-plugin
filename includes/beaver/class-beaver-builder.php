...
class MULE_Beaver_Builder {
	...
	static public function load_modules() {
		...
		require_once MULE_PATH . 'includes/beaver/modules/basic-example/basic-example.php';
		require_once MULE_PATH . 'includes/beaver/modules/example/example.php';
	...
	static public function register_fields( $fields ) {
		...
		$fields['mule-custom-beaver-field'] = MULE_PATH . 'includes/beaver/fields/custom-fields.php';
		return $fields;
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'mule-beaver-fields', MULE_URL . 'includes/beaver/assets/css/fields.css', [], '' );
		wp_enqueue_script( 'mule-beaver-fields', MULE_URL . 'includes/beaver/assets/js/fields.js', [], '', true );
...
// Run the class.
$mule_beaver_builder = new MULE_Beaver_Builder;