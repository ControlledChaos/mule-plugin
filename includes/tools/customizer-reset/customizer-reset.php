...
namespace Mule_Plugin\Includes\Tools\Customizer_Reset;
...
final class Customizer_Reset {
	...
	public function customize_controls_print_scripts() {
		...
		wp_enqueue_script( 'mule-customizer-reset', MULE_URL . 'includes/tools/customizer-reset/assets/js/customizer-reset.js', [ 'jquery' ], '20150120' );

		wp_localize_script( 'mule-customizer-reset', '_MULECustomizerReset', [
			'reset'   => __( 'Reset', 'mule-plugin' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'mule-plugin' ),
			'nonce'   => [
 ...
 */
function mule_customizer_reset() {
