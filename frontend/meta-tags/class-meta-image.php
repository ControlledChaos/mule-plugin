...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'mule_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( mule_acf_options() ) {
			...
			$blog_image    = get_field( 'mule_meta_blog_image', 'option' );
			$default_image = get_field( 'mule_meta_default_image', 'option' );
